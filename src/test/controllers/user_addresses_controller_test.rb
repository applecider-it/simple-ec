...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference("UserAddress.count") do
      post user_addresses_url, params: { user_address: { address_line1: @user_address.address_line1, address_line2: @user_address.address_line2, city: @user_address.city, phone_number: @user_address.phone_number, postal_code: @user_address.postal_code, prefecture: @user_address.prefecture, user_id: @user_address.user_id } }
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: { user_address: { address_line1: @user_address.address_line1, address_line2: @user_address.address_line2, city: @user_address.city, phone_number: @user_address.phone_number, postal_code: @user_address.postal_code, prefecture: @user_address.prefecture, user_id: @user_address.user_id } }
